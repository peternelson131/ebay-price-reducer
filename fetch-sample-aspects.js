...
async function run() {
  ...
  console.log('📥 Fetching required aspects for sample categories\n');
  ...
  for (const cat of sampleCategories) {
    ...
    if (error) {
      ...
      console.log(`   Required: ${requiredAspects.map(a => a.name).join(', ')}`);
    }
  }

  console.log('\n📊 Sample data stored in ebay_category_aspects');
}

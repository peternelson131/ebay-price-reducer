...
async function test() {
  console.log('🧪 Testing Create Listing flow (as if from UI)\n');
  ...
  // Test: Nintendo Switch game - B07VGRJDFY (Link's Awakening)
  console.log('ASIN: B07VGRJDFY (Link\'s Awakening)');
  console.log('Price: $49.99');
  console.log('Condition: NEW');
  console.log('Publish: false (draft only)\n');

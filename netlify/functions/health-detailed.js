 ...
 * 
 * Comprehensive health check with database connectivity, environment validation,
 * and eBay API configuration checks. Use for diagnostics, not uptime monitoring.
 */

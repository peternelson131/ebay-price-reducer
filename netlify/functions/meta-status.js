  ...
  try {
    ...
    if (event.httpMethod === 'GET') {
      ...
      const { data: connection } = await supabase
        ...
        .select('account_id, account_name, account_avatar, instagram_account_id, instagram_username, connected_at, is_active, token_expires_at, access_token')
        .eq('user_id', userId)
        .eq('platform', 'meta')
        .single();
      ...
      return successResponse({
        ...
        connection: connection ? {
          ...
          instagramId: connection.instagram_account_id,
